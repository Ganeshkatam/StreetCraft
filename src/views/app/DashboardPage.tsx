                    ...
                    <button
                      ...
                      onClick={() => {
                        onLaunchPreset({
                          id: `opp_fest_${f.id}`,
                          tag: 'CALENDAR',
                          title: `${f.name} (${f.relativeTimeLabel})`,
                          description: `${f.marketing_relevance}. Launch a campaign to capture holiday and celebration foot traffic.`,
                          ...
                          preset: {
                            ...
                            offer: {
                              ...
                              description: `${f.name} celebration special at ${profile?.name || 'our storefront'}.`,
