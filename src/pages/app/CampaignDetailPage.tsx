...
export const CampaignDetailPage: React.FC<CampaignDetailPageProps> = ({ businessId }) => {
  ...
  // Initialize notes when item is loaded
  React.useEffect(() => {
    if (item) {
  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: '24px', padding: '24px' }}>
        ...
        {/* Campaign Parameters Summary Grid */}
      ...
      {/* Operator Walk-in Notes & Results Card */}
