...
export const CAMPAIGN_TYPES: Record<CampaignType, CampaignTypeMeta> = {
  ...
  MENU_LAUNCH: {
    ...
    recommendedAudience: 'Foodies, regulars, and adventurous local diners',
  },
  FESTIVAL_SPECIAL: {
    type: 'FESTIVAL_SPECIAL',
    label: 'Festival or Holiday Special',
    defaultObjective: 'FESTIVAL_RUSH',
    description: 'Celebrate local and national cultural moments with festive boxes, feasts, or pre-booking deals.',
  ...
  REVIEW_SPOTLIGHT: {
    ...
    description: 'Highlight 5-star local feedback to build social proof and attract new neighborhood discoverers.',
    recommendedAudience: 'Local residents who have not yet visited',
  },
  WIN_BACK_REGULARS: {
