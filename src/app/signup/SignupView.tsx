          ...
          <div className="auth-card-col">
            ...
            <footer className="auth-security-badge" style={{ flexDirection: 'column', gap: '6px' }}>
              ...
              <div style={{ fontSize: '11px', color: 'var(--color-ink-muted)' }}>
                ...
                <button type="button" onClick={() => router.push('/terms')} style={{ textDecoration: 'underline', color: 'inherit', background: 'none', border: 'none', cursor: 'pointer' }}>Terms</button>
                {' '}&amp;{' '}
                <button type="button" onClick={() => router.push('/privacy')} style={{ textDecoration: 'underline', color: 'inherit', background: 'none', border: 'none', cursor: 'pointer' }}>Privacy Policy</button>.
              </div>
            </footer>
          </div>
        </main>
