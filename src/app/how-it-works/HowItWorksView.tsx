        ...
        <section style={{ margin: '0 auto 64px' }}>
          ...
          >
            ...
            >
              ...
              >
                <span style={{ fontSize: '11px', fontFamily: 'var(--font-mono)', color: 'var(--color-primary)', fontWeight: 600, display: 'block', marginBottom: '8px', letterSpacing: '0.06em' }}>
                  INPUT &bull; STAGE 01
                </span>
              ...
              <div style={{ background: 'var(--color-surface-raised)', padding: '24px 28px', borderRadius: 'var(--radius-xs)', border: '1px solid var(--color-border)' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '13.5px' }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-danger, #b42828)', fontWeight: 600 }}>-₹150 commission (30%)</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '13.5px' }}>
                    <span style={{ color: 'var(--color-ink-soft)' }}>Agency Retainer</span>
                    <span style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-danger, #b42828)', fontWeight: 600 }}>High recurring monthly fee</span>
                  </div>
