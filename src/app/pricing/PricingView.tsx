...
export function PricingView() {
  ...
  return (
    <>
      <header className="main-header">
        <div className="header-container">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
            ...
            <Link href="/pricing" className="btn-ghost" style={{ fontSize: '13.5px', color: 'var(--color-primary)' }}>
              Pricing
            </Link>
      ...
      <main style={{ maxWidth: '1360px', margin: '0 auto', padding: '40px var(--space-gutter) 80px' }}>
                ...
                <div style={{ width: '100%' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '28px', width: '100%', textAlign: 'left', background: 'var(--color-surface-raised)', padding: '28px 32px', borderRadius: 'var(--radius-xs)', alignItems: 'center' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--color-border)', paddingLeft: '28px' }}>
                      <button className="btn-primary" style={{ width: '100%', padding: '14px', fontSize: '14.5px', justifyContent: 'center', background: 'var(--color-ink)', color: '#FFFFFF' }} onClick={() => router.push('/login')}>
                        Become a Founder
                      </button>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  onClick={() => router.push(p.monthly_inr === 0 ? '/free-tool' : '/login')}
                >
        ...
        {/* The Store Unit Economics Panel */}
